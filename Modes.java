...
public class Modes
{
   ...
   {
      int[] tally = {0,0,10,5,10,0,7,1,0,6,0,10,3,0,0,1,0,0,0};
      //int[] tally = {5, 5, 5};
   ...
   */
   public static int kthDataValue(int[] tally, int k)
   {
      ...
      return the position of the value at k in tally
      */
      int count = 0;
      int i = 0;
      while (k>count)   {
      ...
      return i-1;  //just to make it compile
   }
